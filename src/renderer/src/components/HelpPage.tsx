    ...
    return (
        <div className="p-8 max-w-4xl mx-auto flex flex-col h-full">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-400">Configure your Jira integration and read the user manual.</p>
            </div>
            ...
            <div className="flex gap-4 mb-8 border-b border-gray-700 pb-1">
                <button
                    ...
                    className={`pb-2 px-1 text-sm font-bold uppercase transition-colors relative ${activeTab === 'settings' ? 'text-blue-500' : 'text-gray-400 hover:text-white'}`}
                >
                    Settings
                    {activeTab === 'settings' && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-500 rounded-t-full"></span>}
                </button>
                <button
                    onClick={() => setActiveTab('manual')}
                    className={`pb-2 px-1 text-sm font-bold uppercase transition-colors relative ${activeTab === 'manual' ? 'text-blue-500' : 'text-gray-400 hover:text-white'}`}
                >
                    User Manual
                    {activeTab === 'manual' && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-500 rounded-t-full"></span>}
                </button>
            </div>
                        ...
                        <div className="space-y-4 max-w-xl">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-900 text-white rounded p-3 border border-gray-700 focus:ring-2 focus:ring-blue-500 outline-none"
                                    value={config.host}
                            ...
                            <div className="pt-2">
                                <button
                                    disabled={loading}
                                    onClick={handleSave}
                                    className="px-6 py-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white rounded-lg font-bold transition-colors"
                                >
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
                                <div className="w-8 h-8 bg-blue-500/20 text-blue-400 rounded-full flex items-center justify-center font-bold mb-4">1</div>
                                <h3 className="font-bold text-white mb-2">Go to Atlassian Account Settings</h3>
                                <p className="text-gray-400 text-sm">
                                    Log in to your Jira account and go to <a href="#" onClick={() => window.open('https://id.atlassian.com/manage-profile/security/api-tokens')} className="text-blue-400 hover:underline">Security Settings</a>.
                                </p>
                            </div>

                            <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
                                <div className="w-8 h-8 bg-blue-500/20 text-blue-400 rounded-full flex items-center justify-center font-bold mb-4">2</div>
                            ...
                            <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
                                <div className="w-8 h-8 bg-blue-500/20 text-blue-400 rounded-full flex items-center justify-center font-bold mb-4">3</div>
            ...
            {activeTab === 'manual' && (
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 overflow-y-auto pb-12 pr-4 custom-scrollbar">
                    ...
                    <section className="bg-gray-800 rounded-xl p-6 border border-gray-700">
                        ...
                        <p className="text-gray-300 mb-4">Welcome to the <strong>Release Analyzer</strong>. This application helps you track software releases and analyze Service Level Agreement (SLA) compliance based on Jira data.</p>
                        <h3 className="font-bold text-blue-400 mb-2">Launching the App</h3>
                        <p className="text-gray-400 text-sm">Open the application from your desktop or Applications folder. Upon launch, you will see the main dashboard where you can create or select a project.</p>
                    </section>

                    <section className="bg-gray-800 rounded-xl p-6 border border-gray-700">
                        <h2 className="text-xl font-bold text-white mb-4">2. Managing Projects</h2>
                        <h3 className="font-bold text-blue-400 mb-2">Creating a Project</h3>
                        <ol className="list-decimal list-inside text-gray-400 text-sm space-y-1 mb-4">
                        ...
                        <h3 className="font-bold text-blue-400 mb-2">Importing Data</h3>
                        <p className="text-gray-400 text-sm mb-2">You can import data in two ways:</p>
                    ...
                    <section className="bg-gray-800 rounded-xl p-6 border border-gray-700">
                        ...
                        <p className="text-gray-300 mb-4">Access it by clicking <strong>⏱️ SLA Dashboard</strong> in the sidebar.</p>

                        <div className="bg-blue-900/30 p-4 rounded-lg border-l-4 border-blue-500 mb-6">
                            <strong className="text-blue-300">Tip:</strong> <span className="text-blue-200 text-sm">The dashboard automatically filters data for the <strong>Current Month</strong> by default.</span>
                        </div>

                        <h3 className="font-bold text-blue-400 mb-2">Tab Navigation</h3>
                        ...
                        <h3 className="font-bold text-blue-400 mb-2">Understanding the Charts</h3>
                        <ul className="list-disc list-inside text-gray-400 text-sm space-y-1">
